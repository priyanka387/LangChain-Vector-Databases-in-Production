...
eleven_apikey = os.getenv("ELEVEN_API_KEY")

my_activeloop_org_id = "priyankasap92"
my_activeloop_dataset_name = "voice_assistant"
dataset_path= 'hub://{my_activeloop_org_id}/{my_activeloop_dataset_name}'



embeddings =  OpenAIEmbeddings(openai_api_key=openai_apikey, model="text-embedding-ada-002")
